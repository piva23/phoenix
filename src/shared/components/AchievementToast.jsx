...
// Escuta as conquistas recentes do useAchievementStore e exibe um toast.
...
// Mapa rápido de IDs para definições
...
function AchievementToastInner() {
  ...
  useEffect(() => {
    ...
    // Processa cada conquista recente com delay escalonado
